...
function create()
  ...
  openTasksButton = modules.client_topmenu.addRightGameToggleButton("openTasksButton", tr("Open Tasks Panel"), "/images/topbuttons/ancestraltask", toggleTasksPanel, true)
  trackerButton = modules.client_topmenu.addRightGameToggleButton("trackerButton", tr("Tasks Tracker"), "/images/topbuttons/ancestraltasktracker", toggleTracker, true)
...
function onTasksRanking(data)
    tasksWindow.ranking:setText("Current Ancestral Ranking: " .. data.rank)
end
