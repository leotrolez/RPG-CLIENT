...
function init()    
    ...
    tutorialButton = modules.client_topmenu.addRightGameToggleButton("tutorialWindowID", tr("Guide"), "/images/topbuttons/guide", onClickTutorial, true)
...
function onCLickBackButton()
    ...
    for y = 1, #tutorialsIndex do
        for x = 1, #tutorialsInfo[y] do
            local label = form.indexList:getChildById(y .. x)
