...
function getIconByVocation(vocation)
  if vocation == "Knight" then
    return "icons/Knight"
  elseif vocation == "Elite Knight" then
    return "icons/Knight" 
  elseif vocation == "Paladin" then
    return "icons/Paladin" 
  elseif vocation == "Royal Paladin" then
    return "icons/Paladin" 
  elseif vocation == "Druid" then
    return "icons/Druid"
  elseif vocation == "Elder Druid" then
    return "icons/Druid"
  elseif vocation == "Sorcerer" then
    return "icons/Sorcerer"
  elseif vocation == "Master Sorcerer" then
    return "icons/Sorcerer"
  elseif vocation == "Illusionist" then
	return "icons/Sorcerer"
  elseif vocation == "Arch Illusionist" then
	return "icons/Sorcerer"
  else
    return "icons/None"
  end
