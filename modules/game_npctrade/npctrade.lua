...
local currencyCode = "G"
local playerCoinAmount = 0 
local CUSTOM_CURRENCY_OPCODE = 125
ProtocolGame.registerExtendedOpcode(CUSTOM_CURRENCY_OPCODE, function(protocol, opcode, buffer)
  currencyCode = buffer
end)


local COIN_AMOUNT_OPCODE = 126
ProtocolGame.registerExtendedOpcode(COIN_AMOUNT_OPCODE, function(protocol, opcode, buffer)
  playerCoinAmount = tonumber(buffer) or 0
end)
...
function refreshPlayerGoods()
  ...
  moneyLabel:setText(formatMoney(playerMoney))
...
function formatCurrency(amount)
  if currencyCode == "V" then
    return amount .. " Vyrsk Coins"
  elseif currencyCode == "F" then
    return amount .. " Frosthold Coins"
  elseif currencyCode == "D" then
    return amount .. " Dorn Coins"
  elseif currencyCode == "H" then
    return amount .. " Hallowfall Coins"
  elseif currencyCode == "E" then
    return amount .. " Vardenfell Coins"
  elseif currencyCode == "SC" then
    return amount .. " Silver Token"
  elseif currencyCode == "AZ" then
    return amount .. " Azure Coin"
  elseif currencyCode == "DC" then
    return amount .. " Dark Chocolate Coin"
  elseif currencyCode == "G" then
    return amount .. " Gold"
  else
...
function formatMoney(amount)
  if currencyCode == "V" then
    return playerCoinAmount .. " Vyrsk Coins"
  elseif currencyCode == "F" then
    return playerCoinAmount .. " Frosthold Coins"
  elseif currencyCode == "D" then
    return playerCoinAmount .. " Dorn Coins"
  elseif currencyCode == "H" then
    return playerCoinAmount .. " Hallowfall Coins"
  elseif currencyCode == "E" then
    return playerCoinAmount .. " Vardenfell Coins"
  elseif currencyCode == "SC" then
    return playerCoinAmount .. " Silver Token"
  elseif currencyCode == "AZ" then
    return playerCoinAmount .. " Azure Coin"
  elseif currencyCode == "DC" then
    return playerCoinAmount .. " Dark Chocolate Coin"
  elseif currencyCode == "G" then
    return playerMoney .. " Gold"
  else
    if CURRENCY_DECIMAL then
      return string.format('%.02f', amount / 100.0) .. ' ' .. CURRENCY
    else
